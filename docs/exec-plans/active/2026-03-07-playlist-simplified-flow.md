...
- [x] Task 1: Make `raw` optional in DownloadRequest _(completed 2026-03-08)_
- [x] Task 2: Add `/api/resolve-playlist` endpoint _(completed 2026-03-08)_
- [x] Task 3: Add TypeScript types and API functions _(completed 2026-03-08)_
- [x] Task 4: Rewrite popup.html with action bar _(completed 2026-03-08)_
- [x] Task 5: Add action bar CSS _(completed 2026-03-08)_
- [x] Task 6: Rewrite popup.ts with new flow _(completed 2026-03-08)_
- [x] Task 7: Clean up unused preview code _(completed 2026-03-08)_
...
|------|------|--------|--------|
| 2026-03-08 | Task 3 had to touch popup.ts to remove fetchPreview import | Minor — added stub throw to keep build passing | Task 6 will fully rewrite popup.ts anyway |

## Plan Drift

| Task | Planned | Actual | Why |
|------|---------|--------|-----|
| Task 3 | Only modify types.ts and api.ts | Also modified popup.ts (removed fetchPreview import, added stub) | Build would fail without removing the import |
